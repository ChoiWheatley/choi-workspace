...
namespace bptree
{
  ...
  */
  ...
  public:
    ...
    virtual auto childNodes() const noexcept -> const vector<optional<NodePtr>> & = 0;
  ...
  */
  ...
  public:
    ...
    auto childNodes() const noexcept -> const vector<optional<NodePtr>> & override
    {
      return mChildNodes;
    }
  ...
  private:
    ...
    vector<optional<NodePtr>> mChildNodes{};
  };
